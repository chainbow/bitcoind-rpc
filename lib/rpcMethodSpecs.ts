import { RpcMethodSpecs } from '../src/types/RpcMethods';
...
const rpcMethodSpecs: { [M in RpcMethods]: RpcMethodSpec<M> } = {
  [RpcMethods.GetBlock]: {
    method: RpcMethods.GetBlock,
    params: [] as unknown as [string, (number | undefined)?],
    returnType: {} as RpcMethodReturnTypes[RpcMethods.GetBlock]
  },
  [RpcMethods.GetBlockchainInfo]: {
    method: RpcMethods.GetBlockchainInfo,
    params: [] as unknown as [],
    returnType: {} as RpcMethodReturnTypes[RpcMethods.GetBlockchainInfo]
  },
